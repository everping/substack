...
class VirustotalPlugin(SearchPlugin):
    ...
    def extract(self, url):
        headers = {"Cookie":"VT_PREFERRED_LANGUAGE=en; __utma=194538546.1669411933.1482685628.1482685628.1482685628.1; __utmb=194538546.1.10.1482685628; __utmc=194538546; __utmz=194538546.1482685628.1.1.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); __utmt=1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:50.0) Gecko/20100101 Firefox/50.0","Host":"www.virustotal.com"}
